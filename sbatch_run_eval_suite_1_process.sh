...
#SBATCH --output=sbatch_eval_suite-config_may26_4.out
#SBATCH --error=sbatch_eval_suite-config_may26_4.err

set -euo pipefail

cd "${SLURM_SUBMIT_DIR}"

CHECKPOINT_PATH="/network/scratch/l/luke.rowe/experiments/config_may26_4/drivor_compatible_last.ckpt"
OUTPUT_BASE="/network/scratch/l/luke.rowe/hugsim_output/benchmark/config_may26_4"
